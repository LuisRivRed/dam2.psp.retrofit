...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class ComSquareupRetrofit2LibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>xuse</b> with <b>com.squareup.retrofit2:<use</b> coordinates and
         * with version reference <b>squareupXuseVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getXuse() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("com.squareup.retrofit2.xuse");
        }
    ...
    public static class OrgMockitoMockitoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core3</b> with <b>org.mockito:mockito-core</b> coordinates and
         * with version reference <b>orgMockitoMockitoCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCore3() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("org.mockito.mockito.core3");
        }
    ...
    public static class Retrofit2KotlinxSerializationLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>retrofit2KotlinxSerializationConverterVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>orgMockitoMockitoCore</b> with value <b>5.3.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOrgMockitoMockitoCore() { return getVersion("orgMockitoMockitoCore"); }
        ...
        /**
         * Version alias <b>retrofit2KotlinxSerializationConverterVersion</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>serialization</b> with value <b>2.1.20-Beta2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>squareupXuseVersion</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSquareupXuseVersion() { return getVersion("squareupXuseVersion"); }
