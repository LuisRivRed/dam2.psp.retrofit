...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class JetbrainsKotlinxLibraryAccessors extends SubDependencyFactory {
        private final JetbrainsKotlinxSerializationLibraryAccessors laccForJetbrainsKotlinxSerializationLibraryAccessors = new JetbrainsKotlinxSerializationLibraryAccessors(owner);

        public JetbrainsKotlinxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>jetbrains.kotlinx.serialization</b>
         */
        public JetbrainsKotlinxSerializationLibraryAccessors getSerialization() {
            return laccForJetbrainsKotlinxSerializationLibraryAccessors;
        }

    }

    public static class JetbrainsKotlinxSerializationLibraryAccessors extends SubDependencyFactory {

        public JetbrainsKotlinxSerializationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getJson() {
            return create("jetbrains.kotlinx.serialization.json");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinxCoroutinesTest</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxSerializationJsonVersion</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
